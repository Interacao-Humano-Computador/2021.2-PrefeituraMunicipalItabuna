...
<p align='justify'>
  Foram dispostas à entrevistada 4 tarefas, descritas na Planejamento da Avaliação do Protótipo. Foi bom no geral, a entrevistada não encontrou problemas significativos no design proposto, relatando somente uma dificuldade no menu por não apresentar um barra de rolagem para indicar que pode fazer a rolagem do menu para encontar as informações sobre as secretárias. 
</p>
